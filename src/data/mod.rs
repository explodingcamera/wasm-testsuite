...
impl From<Proposal> for &'static str {
    fn from(proposal: Proposal) -> &'static str {
        match proposal {
            ...
            Proposal::ExceptionHandling => "exceptions",
            ...
            Proposal::BulkMemoryOperations => "bulk-memory",
...
impl FromStr for Proposal {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(match s {
            ...
            "exception-handling" | "exceptions" => Proposal::ExceptionHandling,
            ...
            "bulk-memory-operations" | "bulk-memory" => Proposal::BulkMemoryOperations,
